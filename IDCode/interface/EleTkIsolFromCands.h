#ifndef HEEP_IDCODE_ELETKISOLFROMCANDS_H
#define HEEP_IDCODE_ELETKISOLFROMCANDS_H
...
#if __has_include("RecoEgamma/EgammaIsolationAlgos/interface/EleTkIsolFromCands.h") 
#error EleTrkIsolFromCands is in the release, this file should be removed from the build
#endif
